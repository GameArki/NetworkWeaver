...
namespace GameArki.Network {
    ...
    public class UdpLowLevelClient {
        ...
        public ClientConnectionType ConnectionType => connectionType;
        ...
        public void Connect(string host, int port, string key) {
            ...
            connectionType = ClientConnectionType.Connecting;
        ...
        void OnConnected(NetPeer peer) {
            ...
            connectionType = ClientConnectionType.Connected;
        }
        ...
        public void Stop() {
            client.Stop();
            connectionType = ClientConnectionType.None;
        }
